            ...
            <div className='card bg-base-100'>
              <div className='card-body'>
                ...
                <form onSubmit={handleSubmit}>
                  <div className='form-control mb-4'><label className='label'>
                  ...
                  <div className='form-control mb-4'><label className='label'><span className='label-text'> Author </span></label>
                  ...
                  <div className='form-control mb-4'>
                        <label className='label'><span className='label-text'> Year of Publishing </span></label>
